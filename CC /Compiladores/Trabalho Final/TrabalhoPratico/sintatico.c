...
{
       0,    48,    48,    59,    66,    67,    71,    79,    89,    91,
      95,   101,   111,   112,   122,   123,   124,   125,   126,   129,
     137,   146,   156,   167,   177,   184,   191,   198,   205,   212,
     219,   226,   233,   240,   244,   250,   251,   252,   253,   259
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_IGUAL", "T_E", "T_OU", "T_NAO", "T_V", "T_F", "T_NUM", "T_ABRE",
...
{
       0,     0,     0,     4,     3,     1,     8,     9,     0,     5,
       0,    12,    10,     7,     0,     0,     0,     0,     0,     0,
      12,    14,    15,    16,    17,    18,    11,     6,     0,    19,
      34,     0,    36,    37,    35,     0,    20,    33,     0,     0,
...
#line 49 "sintatico.y"
        {
            raiz = criaNo(PROG, "");
            adicionaFilho(raiz, yyvsp[-1]);
            adicionaFilho(raiz, yyvsp[-3]);
            adicionaFilho(raiz, yyvsp[-4]);
...
#line 72 "sintatico.y"
        {
            ptno p = criaNo(DCVR, "");
            adicionaFilho(p, yyvsp[0]);
            adicionaFilho(p, yyvsp[-1]);
            adicionaFilho(p, yyvsp[-2]);
            yyval = p;
        }
...
#line 1508 "sintatico.c"
  ...
  case 10: /* lista_variaveis: T_IDENTIF  */
#line 96 "sintatico.y"
        {
            ptno p = criaNo(LIVR, "");
            adicionaFilho(p, yyvsp[0]);
...
#line 157 "sintatico.y"
        {
            ...
            adicionaFilho(p, yyvsp[-1]);
            adicionaFilho(p, yyvsp[-3]);
            adicionaFilho(p, yyvsp[-5]);
            yyval = p;
        }
#line 1619 "sintatico.c"
    break;

  case 23: /* atribuicao: T_IDENTIF T_ATRIB expressao  */
...
#line 1630 "sintatico.c"
  ...
  case 24: /* expressao: expressao T_VEZES expressao  */
...
#line 1641 "sintatico.c"
  ...
  case 25: /* expressao: expressao T_DIV expressao  */
...
#line 1674 "sintatico.c"
  ...
  case 28: /* expressao: expressao T_MAIOR expressao  */
...
#line 1685 "sintatico.c"
  ...
  case 29: /* expressao: expressao T_MENOR expressao  */
...
#line 1696 "sintatico.c"
  ...
  case 30: /* expressao: expressao T_IGUAL expressao  */
...
#line 1707 "sintatico.c"
  ...
  case 31: /* expressao: expressao T_E expressao  */
...
#line 1718 "sintatico.c"
  ...
  case 32: /* expressao: expressao T_OU expressao  */
...
#line 1767 "sintatico.c"
  ...
  case 39: /* termo: T_ABRE expressao T_FECHA  */
